...
public class ReservationManager {
    ...
    /**
     * เพิ่มผู้ฟังการเปลี่ยนแปลง หากยังไม่มีในรายการ
     * @param l ผู้ฟังที่ต้องการเพิ่ม
     */
    public synchronized void addListener(ReservationListener l) {
        if (l != null && !listeners.contains(l)) listeners.add(l);
    }

    /**
     * ลบผู้ฟังการเปลี่ยนแปลงออกจากรายการ
     * @param l ผู้ฟังที่ต้องการลบ
     */
